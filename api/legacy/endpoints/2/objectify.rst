...
need this much information, we suggest using the :doc:`/api/embed/endpoints/1/oembed` or
:doc:`/api/extract/endpoints/1/extract`.
...
``oembed``
    The oEmbed response for a url. More information on the :doc:`/api/embed/endpoints/1/oembed`.
